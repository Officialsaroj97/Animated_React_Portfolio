  ...
  return (
    <div className="container project my-3" id="projects">
      ...
      <div className="row d-flex justify-content-center align-items-center">
        {project.map((data) => (
          <div
            key={data.id} // Ensure the key is unique and properly placed
          ...
          >
            ...
            >
              <div className="img d-flex justify-content-center align-items-center p-3">
                <img
                  src={`/assets/${data.imageSrc}`} // Use data.imageSrc instead of project.imageSrc
                  alt={data.title} // Move alt to img element
                  style={{
                    width: "250px",
                    height: "200px",
